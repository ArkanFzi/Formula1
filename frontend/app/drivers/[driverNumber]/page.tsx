...
export default async function DriverProfilePage({
  ...
  const [driver, performance, latestLap] = await Promise.all([
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 lg:skew-x-[-4deg]">
              ...
              <div className="bg-white/5 border border-white/5 p-4 transition-colors hover:bg-white/10 text-right">
                ...
                <span className="text-xs font-black uppercase tracking-tighter font-mono text-[#e10600]">LIVE.F1</span>
              </div>
            </div>
          </div>

          {/* ── Right Column: Technical Dossier Content ── */}
          <div className="lg:col-span-7">
            ...
            <div className="mt-16 flex justify-between items-center opacity-20 select-none">
                <span className="text-[8px] font-mono tracking-widest uppercase">system_auth: {Math.random().toString(16).slice(2, 10)}</span>
